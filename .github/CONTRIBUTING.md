...
1. [Create a fork](https://help.github.com/articles/fork-a-repo) of the upstream
   repository at [`mapp-metabolomics-unit/mapp-metadata-checker`](https://github.com/mapp-metabolomics-unit/mapp-metadata-checker)
   on your GitHub account (or in one of your organizations)
2. [Clone your fork](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository)
   with `git clone https://github.com/<your namespace here>/mapp-metadata-checker.git`
...
```shell
$ git remote add mapp-metabolomics-unit https://github.com/mapp-metabolomics-unit/mapp-metadata-checker.git
```
